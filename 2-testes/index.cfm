...
<!---    <CFDUMP VAR="#validausuario#"> --->
    <cfif validausuario.recordcount GT 0>
        ...
        <cfif validausuario.user_level eq "R">
            <meta http-equiv="refresh" content="0; URL=/cf/auth/qualidade/buy_off_T/fa_selecionar_reparo.cfm"/>
        <cfelse>
...
<!---    <CFDUMP VAR="#validausuario#"> --->
    <cfif validausuario.recordcount GT 0>
        ...
        <cfelse>
            <meta http-equiv="refresh" content="0; URL=/cf/auth/qualidade/buyoff_linhat/SELECAO_PAINT.cfm"/>
        </cfif>
    <cfelse>
        <u class="btn btn-danger" style="width: 100%">USUÁRIO OU SENHA INCORRETA</u>
           </cfif>
...
<div id="form-cadastro" class="form-section" style="display: none;">
    <form method="post" action="cadastro.cfm">
        ...
        <div class="form-group">
            ...
            <input required type="text" class="form-control" id="cadastro_usuario" name="cadastro_usuario" oninput="removerBordaVermelha(this)">
        </div>
        <div class="form-group">
