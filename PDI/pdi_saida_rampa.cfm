<cfinvoke method="inicializando" component="cf.ini.index">
   ...
   <cfif structKeyExists(url, "id") and url.id neq "">
      ...
      <script>
         self.location = 'pdi_saida_rampa.cfm';
      </script>
   </cfif>
      ...
      <head>
         ...
         <script>
            function validarFormulario(event) {
                ...
                xhr.send('vin=' + vin + '&problema=' + problema + '&barreira=RAMPA');
            }
      ...
      <body>
         ...
         <div class="container mt-4">
            ...
            <form onsubmit="return validarFormulario(event);" method="post" id="form_envio">
               ...
               <cfoutput>
                  <script>
                     window.location.href = 'pdi_saida_rampa.cfm';
                  </script>
               </cfoutput>
               </cfif>
               <script>
         ...
         <script>
            function deletar(id) {
                if (confirm("Tem certeza que deseja deletar este item?")) {
                    window.location.href = "pdi_saida_rampa.cfm?id=" + id;
                }
            }
         </script>
         <script>
