<cfinvoke method="inicializando" component="cf.ini.index">
   ...
   <cfif structKeyExists(url, "id") and url.id neq "">
      ...
      <script>
         self.location = 'pdi_saida_patio_nacional.cfm';
      </script>
   </cfif>
   ...
   <html lang="pt-BR">
      <head>
         ...
         <script>
            function validarFormulario(event) {
                ...
                xhr.send('vin=' + vin + '&problema=' + problema + '&barreira=NACIONAL');
            }
      ...
      <body>
         ...
         <div class="container mt-4">
            <h2 class="titulo2">PDI - NACIONAL</h2>
            <br>
            ...
            <form onsubmit="return validarFormulario(event);" method="post" id="form_envio">
               ...
               <cfoutput>
                  <script>
                     window.location.href = 'pdi_saida_patio_nacional.cfm';
                  </script>
               </cfoutput>
               </cfif>
               <script>
         ...
         <script>
            function deletar(id) {
                if (confirm("Tem certeza que deseja deletar este item?")) {
                    window.location.href = "pdi_saida_patio_nacional.cfm?id=" + id;
                }
            }
         </script>
         <script>
