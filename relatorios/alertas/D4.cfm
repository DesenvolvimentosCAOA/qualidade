<cfinvoke method="inicializando" component="cf.ini.index">
    ...
    <cfif isDefined("form.causa_raiz") and form.causa_raiz neq "">
        <cfquery name="atualiza" datasource="#BANCOSINC#">
            UPDATE INTCOLDFUSION.ALERTAS_8D
            SET              
                MAO_OBRA_1 = <cfqueryparam value="#UCase(form.mao_obra_1)#" cfsqltype="CF_SQL_CLOB">,
                MAO_OBRA_2 = <cfqueryparam value="#UCase(form.mao_obra_2)#" cfsqltype="CF_SQL_CLOB">,
                MAO_OBRA_3 = <cfqueryparam value="#UCase(form.mao_obra_3)#" cfsqltype="CF_SQL_CLOB">,
                MAO_OBRA_4 = <cfqueryparam value="#UCase(form.mao_obra_4)#" cfsqltype="CF_SQL_CLOB">,
                MAO_OBRA_5 = <cfqueryparam value="#UCase(form.mao_obra_5)#" cfsqltype="CF_SQL_CLOB">,
                MATERIAL_1 = <cfqueryparam value="#UCase(form.material_1)#" cfsqltype="CF_SQL_CLOB">,
                MATERIAL_2 = <cfqueryparam value="#UCase(form.material_2)#" cfsqltype="CF_SQL_CLOB">,
                MATERIAL_3 = <cfqueryparam value="#UCase(form.material_3)#" cfsqltype="CF_SQL_CLOB">,
                MATERIAL_4 = <cfqueryparam value="#UCase(form.material_4)#" cfsqltype="CF_SQL_CLOB">,
                MATERIAL_5 = <cfqueryparam value="#UCase(form.material_5)#" cfsqltype="CF_SQL_CLOB">,
                MEDIDA_1 = <cfqueryparam value="#UCase(form.medida_1)#" cfsqltype="CF_SQL_CLOB">,
                MEDIDA_2 = <cfqueryparam value="#UCase(form.medida_2)#" cfsqltype="CF_SQL_CLOB">,
                MEDIDA_3 = <cfqueryparam value="#UCase(form.medida_3)#" cfsqltype="CF_SQL_CLOB">,
                MEDIDA_4 = <cfqueryparam value="#UCase(form.medida_4)#" cfsqltype="CF_SQL_CLOB">,
                MEDIDA_5 = <cfqueryparam value="#UCase(form.medida_5)#" cfsqltype="CF_SQL_CLOB">,
                METODO_1 = <cfqueryparam value="#UCase(form.metodo_1)#" cfsqltype="CF_SQL_CLOB">,
                METODO_2 = <cfqueryparam value="#UCase(form.metodo_2)#" cfsqltype="CF_SQL_CLOB">,
                METODO_3 = <cfqueryparam value="#UCase(form.metodo_3)#" cfsqltype="CF_SQL_CLOB">,
                METODO_4 = <cfqueryparam value="#UCase(form.metodo_4)#" cfsqltype="CF_SQL_CLOB">,
                METODO_5 = <cfqueryparam value="#UCase(form.metodo_5)#" cfsqltype="CF_SQL_CLOB">,
                MAQUINA_1 = <cfqueryparam value="#UCase(form.maquina_1)#" cfsqltype="CF_SQL_CLOB">,
                MAQUINA_2 = <cfqueryparam value="#UCase(form.maquina_2)#" cfsqltype="CF_SQL_CLOB">,
                MAQUINA_3 = <cfqueryparam value="#UCase(form.maquina_3)#" cfsqltype="CF_SQL_CLOB">,
                MAQUINA_4 = <cfqueryparam value="#UCase(form.maquina_4)#" cfsqltype="CF_SQL_CLOB">,
                MAQUINA_5 = <cfqueryparam value="#UCase(form.maquina_5)#" cfsqltype="CF_SQL_CLOB">,
                MEIO_AMBIENTE_1 = <cfqueryparam value="#UCase(form.meio_ambiente_1)#" cfsqltype="CF_SQL_CLOB">,
                MEIO_AMBIENTE_2 = <cfqueryparam value="#UCase(form.meio_ambiente_2)#" cfsqltype="CF_SQL_CLOB">,
                MEIO_AMBIENTE_3 = <cfqueryparam value="#UCase(form.meio_ambiente_3)#" cfsqltype="CF_SQL_CLOB">,
                            ...
                            <table>
                                ...
                                <form method="POST">
                                    <tr>
                                        ...
                                        <td class="label-bold" colspan="2" style="text-align:center;">MATERIAL</td>
                                        <td class="label-bold" colspan="3" style="text-align:center;">MEDIDA</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <input type="text" name="mao_obra_1" style="width: 100%;">
                                        </td>
                                        <td colspan="2">
                                            <input type="text" name="material_1" style="width: 100%;">
                                        </td>
                                        <td colspan="3">
                                            <input type="text" name="medida_1" style="width: 100%;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <input type="text" name="mao_obra_2" style="width: 100%;">
                                        </td>
                                        <td colspan="2">
                                            <input type="text" name="material_2" style="width: 100%;">
                                        </td>
                                        <td colspan="3">
                                            <input type="text" name="medida_2" style="width: 100%;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <input type="text" name="mao_obra_3" style="width: 100%;">
                                        </td>
                                        <td colspan="2">
                                            <input type="text" name="material_3" style="width: 100%;">
                                        </td>
                                        <td colspan="3">
                                            <input type="text" name="medida_3" style="width: 100%;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <input type="text" name="mao_obra_4" style="width: 100%;">
                                        </td>
                                        <td colspan="2">
                                            <input type="text" name="material_4" style="width: 100%;">
                                        </td>
                                        <td colspan="3">
                                            <input type="text" name="medida_4" style="width: 100%;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <input type="text" name="mao_obra_5" style="width: 100%;">
                                        </td>
                                        <td colspan="2">
                                            <input type="text" name="material_5" style="width: 100%;">
                                        </td>
                                        <td colspan="3">
                                            <input type="text" name="medida_5" style="width: 100%;">
                                        </td>
                                    </tr>
                                    
                                    <tr>
                                        <td class="label-bold" colspan="2" style="text-align:center">MÉTODO</td>
                                        <td class="label-bold" colspan="2" style="text-align:center">MÁQUINA</td>
                                        <td class="label-bold" colspan="3" style="text-align:center">MEIO AMBIENTE</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <input type="text" name="metodo_1" style="width: 100%;">
                                        </td>
                                        <td colspan="2">
                                            <input type="text" name="maquina_1" style="width: 100%;">
                                        </td>
                                        <td colspan="3">
                                            <input type="text" name="meio_ambiente_1" style="width: 100%;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <input type="text" name="metodo_2" style="width: 100%;">
                                        </td>
                                        <td colspan="2">
                                            <input type="text" name="maquina_2" style="width: 100%;">
                                        </td>
                                        <td colspan="3">
                                            <input type="text" name="meio_ambiente_2" style="width: 100%;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <input type="text" name="metodo_3" style="width: 100%;">
                                        </td>
                                        <td colspan="2">
                                            <input type="text" name="maquina_3" style="width: 100%;">
                                        </td>
                                        <td colspan="3">
                                            <input type="text" name="meio_ambiente_3" style="width: 100%;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <input type="text" name="metodo_4" style="width: 100%;">
                                        </td>
                                        <td colspan="2">
                                            <input type="text" name="maquina_4" style="width: 100%;">
                                        </td>
                                        <td colspan="3">
                                            <input type="text" name="meio_ambiente_4" style="width: 100%;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <input type="text" name="metodo_5" style="width: 100%;">
                                        </td>
                                        <td colspan="2">
                                            <input type="text" name="maquina_5" style="width: 100%;">
                                        </td>
                                        <td colspan="3">
                                            <input type="text" name="meio_ambiente_5" style="width: 100%;">
                                        </td>
                                    </tr>        
                                    <tr>
                                        <td class="label-bold" colspan="1">CAUSA RAIZ:</td>
                                        <td colspan="8">
                                            <textarea name="causa_raiz" placeholder="DESCREVA A CAUSA RAIZ"style="width: 100%; height: 100px; resize: vertical;"></textarea>
                                        </td>
                                    </tr>                                    
                            </table>
