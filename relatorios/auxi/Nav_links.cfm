<nav>
    ...
    <ul>
                ...
                <cfif isDefined("cookie.user_level_final_assembly") and cookie.user_level_final_assembly eq "G">
                    <li class="dropdown-submenu">
                        ...
                        <ul class="submenu">
                            ...
                            <li><a href="/qualidade/relatorios/ver_agir_body.cfm">Body</a></li>
                            <li><a href="/qualidade/relatorios/ver_agir_paint.cfm">Paint</a></li>
                            <li><a href="/qualidade/relatorios/ver_agir_fa.cfm">FA</a></li>
                            <li><a href="/qualidade/relatorios/ver_agir_fai.cfm">FAI</a></li>
                            <li><a href="/qualidade/relatorios/ver_agir_pdi.cfm">PDI</a></li>
                        </ul>
                    </li>
                    <li><a href="/qualidade/relatorios/presenca.cfm">Registrar Presença</a></li>
                </cfif>
      ...
      <li class="dropdown">
          ...
          <ul class="dropdown-menu">
              <cfif isDefined("cookie.user_level_final_assembly") and cookie.user_level_final_assembly eq "G">
                  <li><a href="/qualidade/relatorios/powerpoint.cfm">Treinamento Ver & Agir</a></li>
              </cfif>
              <li><a href="/qualidade/relatorios/powerpoint.cfm">Treinamento Alertas</a></li>
          </ul>
      </li>
