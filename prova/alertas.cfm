    ...
    <cfif verificaExistente.total EQ 0>
        ...
        <cfquery name="insere" datasource="#BANCOSINC#">
            ...
            VALUES(
                ...
                <cfqueryparam value="RESPOSTA DE ALERTAS" cfsqltype="CF_SQL_VARCHAR">
            )
        </cfquery>
...
<head>
    ...
    <title>Treinamento Alertas</title>
    <style>
        body {
            display: flex;
...
<body>
    ...
    <div class="slide-container">
        <img id="slide" src="/qualidade/prova/alerta_resposta/Slide1.jpg" alt="Slide 1">
        <div class="controls">
    ...
    <script>
        const slides = [];
        for (let i = 1; i <= 9; i++) {
            slides.push(`/qualidade/prova/alerta_resposta/Slide${i}.jpg`);
        }
