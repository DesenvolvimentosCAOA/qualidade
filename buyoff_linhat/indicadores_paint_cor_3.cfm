...
<html lang="pt-BR">
    <head>
        ...
        <title>Indicador/ COR - 3º turno</title>
    ...
    <body>
        ...
        <!-- Filtro de data -->
        <h2>Indicador por cor 3º Turno</h2>
        <div class="container">
            <button class="btn btn-warning mb-2 ml-2" onclick="self.location='indicadores_paint_cor_1.cfm'">1º Turno</button>
            <button class="btn btn-warning mb-2 ml-2" onclick="self.location='indicadores_paint_cor_2.cfm'">2º Turno</button>
            <button style="background-color:green; color:white;" class="btn btn-warning mb-2 ml-2" onclick="self.location='indicadores_paint_cor_3.cfm'">3º Turno</button>
            <cfoutput>
                <form method="get" action="indicadores_paint_cor_3.cfm" class="form-inline">
                    <div class="form-group mx-sm-3 mb-2">
                        <label for="filtroData" class="sr-only">Data:</label>
                        <input type="date" class="form-control" name="filtroData" id="filtroData" value="<cfif isDefined('url.filtroData')>#url.filtroData#<cfelse>#DateFormat(Now(), 'yyyy-mm-dd')#</cfif>"/>
                    </div>
                    <button class="btn btn-danger mb-2 ml-2" type="reset" onclick="self.location='indicadores_paint_cor_3.cfm'">Limpar</button>
                </form>
            </cfoutput>
        </div>
