...
<html lang="pt-BR">
    <head>
        ...
        <title>Indicador/ COR - 1º turno</title>
    ...
    <body>
        ...
        <!-- Filtro de data -->
        <h2>Indicador por cor 1º Turno</h2>
        <div class="container">
            <button style="background-color:green; color:white;" class="btn btn-warning mb-2 ml-2" onclick="self.location='indicadores_paint_cor_1.cfm'">1º Turno</button>
            ...
            <cfoutput>
                <form method="get" action="indicadores_paint_cor_1.cfm" class="form-inline">
                    ...
                    <button class="btn btn-danger mb-2 ml-2" type="reset" onclick="self.location='indicadores_paint_cor_1.cfm'">Limpar</button>
                </form>
            </cfoutput>
        </div>
