<cfinvoke method="inicializando" component="cf.ini.index">
 ...
 <!--- Se o código chegou até aqui, significa que o VIN não está bloqueado. O formulário pode ser enviado. --->
    ...
    <!-- Verifica se o VIN existe na BARREIRA 'Top Coat' -->
    ...
    <cfif verificaIntervalo.recordCount gt 0>
       <!-- Se o VIN existe na BARREIRA 'Top Coat', usa o intervalo existente -->
    ...
    <cfquery name="insere" datasource="#BANCOSINC#">
       INSERT INTO INTCOLDFUSION.SISTEMA_QUALIDADE (ID, USER_DATA, USER_COLABORADOR, BARCODE, MODELO, BARREIRA, PECA, POSICAO, PROBLEMA, ESTACAO, CRITICIDADE, INTERVALO)
           VALUES (
    ...
    <cfoutput><script>window.location.href = 'selecao_paint_topcoat.cfm';</script></cfoutput>
    ...
    <cfif structKeyExists(url, "id") and url.id neq "">
        ...
        <script>
            self.location = 'selecao_paint_topcoat.cfm';
        </script>
    </cfif>
 ...
 <script>
    function validarFormulario(event) {
        ...
        xhr.send('barcode=' + encodeURIComponent(barcode) + '&problema=' + encodeURIComponent(problema) + '&barreira=Top Coat');
    ...
    <body>
        ...
        <div class="container mt-4">
            <h2 class="titulo2">Barreira Top Coat</h2><br>
        ...
        <script>
            function deletar(id) {
                if (confirm("Tem certeza que deseja deletar este item?")) {
                    window.location.href = "selecao_paint_topcoat.cfm?id=" + id;
                }
            }
        </script>    
