...
<!--- Se o código chegou até aqui, significa que o VIN não está bloqueado. O formulário pode ser enviado. --->
   ...
   <!-- Verifica se o VIN existe na BARREIRA 'CP6' -->
   ...
   <cfif verificaIntervalo.recordCount gt 0>
      <!-- Se o VIN existe na BARREIRA 'CP6', usa o intervalo existente -->
   ...
   <cfoutput><script>window.location.href = 'paint_barreira_cp6.cfm';</script></cfoutput>
   ...
   <cfif structKeyExists(url, "id") and url.id neq "">
       ...
       <script>
           self.location = 'paint_barreira_cp6.cfm';
       </script>
   </cfif>
...
<script>
   ...
   <body>
       ...
       <div class="container mt-4">
           <h2 class="titulo2">Barreira CP6</h2><br>
       ...
       <script>
           function deletar(id) {
               if (confirm("Tem certeza que deseja deletar este item?")) {
                   window.location.href = "paint_barreira_cp6.cfm?id=" + id;
               }
           }
       </script>    
