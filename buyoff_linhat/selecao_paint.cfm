<cfinvoke method="inicializando" component="cf.ini.index">
 ...
 <!--- Se o código chegou até aqui, significa que o VIN não está bloqueado. O formulário pode ser enviado. --->
    ...
    <!-- Verifica se o VIN existe na BARREIRA 'Primer' -->
    ...
    <cfif verificaIntervalo.recordCount gt 0>
       <!-- Se o VIN existe na BARREIRA 'Primer', usa o intervalo existente -->
 ...
 <script>
    function validarFormulario(event) {
        ...
        xhr.send('barcode=' + encodeURIComponent(barcode) + '&problema=' + encodeURIComponent(problema) + '&barreira=Primer');
    ...
    <body>
        ...
        <div class="container mt-4">
            <h2 class="titulo2">Barreira Primer</h2><br>
