    ...
    <cfoutput>
       ...
       <cfif isDefined("url.user")>
          ...
          <cfquery name="validausuario" datasource="#BANCOSINC#">
              ...
              and user_password = UPPER('#url.senha#')
              and user_name in ('FRANK.CORREA', 'WILKA.SOUSA','ERICK.DANIE', 'LUIZ.BARREIRA', 'CESAR.SANTOS', 'EDUARDA.LEMOS')
          </cfquery>

          <cfif validausuario.recordCount gt 0>
                   <cfcookie  name="user_lotes" value="#url.user#">
                   <meta http-equiv="refresh" content="0; URL=../cadastro.cfm"/>
           <cfelse>
