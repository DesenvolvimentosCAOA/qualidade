<cfinvoke method="inicializando" component="cf.ini.index">
    ...
    <cfquery name="consulta_nconformidades_cp7_AVARIA" datasource="#BANCOSINC#">
        WITH CONSULTA AS (
            ...
            AND PROBLEMA IS NOT NULL
            AND BARREIRA = 'CP7'
            AND CRITICIDADE NOT IN ('N1', 'N2', 'N3', 'N4','OK A-','N0')
            AND (
                -- Segunda a Quinta-feira: turno inicia às 01:02 e termina às 06:10 do mesmo dia
                ((TO_CHAR(USER_DATA, 'D') BETWEEN '2' AND '5') AND (TO_CHAR(USER_DATA, 'HH24:MI:SS') BETWEEN '01:02:00' AND '06:10:00'))
                -- Sexta-feira: turno inicia às 01:02 e termina às 06:10 do mesmo dia
...
<cfif not isDefined("cookie.USER_APONTAMENTO_FA") or cookie.USER_APONTAMENTO_FA eq "">
    ...
    <head>
        ...
        <title>FA SUV CP7 Indicador-3º turno</title>
    ...
    <body>
        ...
        <cfoutput>
            <div class="container">
                <h2>FA SUV CP7 3º Turno</h2>
                <form method="get" action="fa_indicadores_3_esteira.cfm" class="form-inline">
                    ...
                    <button class="btn btn-warning mb-2 ml-2" type="reset" onclick="self.location='fa_indicadores_3_esteira.cfm'">Limpar</button>
                </form>
            </div>
            </cfoutput>
