                ...
                <div class="form-row">
                    <div class="col-md-12">
                        <div class="form-buttons">
                            ...
                            <button type="reset" class="btn btn-primary" style="background:gold; color:black; border-color: gold" onclick="self.location='fa_relatorios_summary.cfm'">Limpar</button>
                        </div>
                    </div>
                </div>
            </form>
