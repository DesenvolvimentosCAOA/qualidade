...
<cfif structKeyExists(url, "id") and url.id neq "">
    ...
    <script>
        self.location = 'fa_barreira_F05.cfm';
    </script>
</cfif>
...
<html lang="pt-BR">
    ...
    <div class="container mt-4">
        <h2 class="titulo2">Barreira F05</h2><br><br>
    ...
    <cfoutput><script>window.location.href = 'fa_barreira_F05.cfm';</script></cfoutput>
                </cfif>
        ...
        <script>
            function deletar(id) {
                if (confirm("Tem certeza que deseja deletar este item?")) {
                    window.location.href = "fa_barreira_F05.cfm?id=" + id;
                }
            }
        </script>
        <script>
