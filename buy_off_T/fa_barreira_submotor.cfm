...
<cfif structKeyExists(form, "nome") and structKeyExists(form, "vin") and structKeyExists(form, "modelo") and structKeyExists(form, "local") and structKeyExists(form, "N_Conformidade") and structKeyExists(form, "posicao") and structKeyExists(form, "problema")>
    ...
    <cfquery name="insere" datasource="#BANCOSINC#">
        INSERT INTO INTCOLDFUSION.sistema_qualidade_fa (
            ID, USER_DATA, USER_COLABORADOR, VIN, MODELO, BARREIRA, PECA, POSICAO, PROBLEMA, ESTACAO, CRITICIDADE, INTERVALO
        ) VALUES (
    ...
    <cfoutput><script>window.location.href = 'fa_barreira_submotor.cfm';</script></cfoutput>
    ...
    <cfif structKeyExists(url, "id") and url.id neq "">
        ...
        <script>
            self.location = 'fa_barreira_submotor.cfm';
        </script>
    </cfif>
    ...
    <body>
        ...
        <div class="container mt-4">
            <h2 class="titulo2">SUB MOTOR</h2><br>
...
<!--- <cfdump var="#buscaMES#"> --->
                ...
                <div class="form-row">
                    <div class="form-group col-md-2">
                        ...
                        <input class="form-control form-control-sm" list="pecaList" name="N_Conformidade" id="formNConformidade" oninput="transformToUpperCase(this)">
        ...
        <script>
            function deletar(id) {
                if (confirm("Tem certeza que deseja deletar este item?")) {
                    window.location.href = "fa_barreira_submotor.cfm?id=" + id;
                }
            }
        </script>    
