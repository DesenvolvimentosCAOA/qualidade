...
<html lang="pt-BR">
    <head>
        ...
        <cfset userDataInserir = Now() /> <!-- Define um valor padrão para USER_DATA -->
        ...
        <cfif not IsNull(verificaIntervalo) AND verificaIntervalo.recordCount gt 0>
            ...
            <cfset userDataInserir = verificaUserData.USER_DATA> <!-- Copia a USER_DATA -->
        <cfelse>
