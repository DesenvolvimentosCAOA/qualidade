...
<script>
   self.location = 'fa_barreira_cp7_hr.cfm';
</script>
</cfif>
<html lang="pt-BR">
   <head>
   ...
   <body>
      ...
      <div class="container mt-4">
         ...
         <form onsubmit="return validarFormulario(event);" method="post" id="form_envio">
            ...
            <cfoutput>
               <script>
                  window.location.href = 'fa_barreira_cp7_hr.cfm';
               </script>
            </cfoutput>
            </cfif>
      ...
      <script>
         function deletar(id) {
             if (confirm("Tem certeza que deseja deletar este item?")) {
                 window.location.href = "fa_barreira_cp7_hr.cfm?id=" + id;
             }
         }
      </script>
      <script>
