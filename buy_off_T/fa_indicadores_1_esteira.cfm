...
<cfif not isDefined("cookie.USER_APONTAMENTO_FA") or cookie.USER_APONTAMENTO_FA eq "">
    ...
    <head>
        ...
        <title>FA SUV CP7 Indicador-1º turno</title>
    ...
    <body>
        ...
        <cfoutput>
            <div class="container">
                ...
                <form method="get" action="fa_indicadores_1_esteira.cfm" class="form-inline">
                    ...
                    <button class="btn btn-warning mb-2 ml-2" type="reset" onclick="self.location='fa_indicadores_1_esteira.cfm'">Limpar</button>
                </form>
            </div>
            </cfoutput>
        ...
        <div class="container-fluid">
            ...
            <!----    <script>
                ...
                <div id="paretoChartCP7" style="width: 500px; height: 400px;"></div> ---->
