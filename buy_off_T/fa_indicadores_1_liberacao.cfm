...
<cfif not isDefined("cookie.USER_APONTAMENTO_FA") or cookie.USER_APONTAMENTO_FA eq "">
    ...
    <head>
        ...
        <title>Liberação indicador - 1º turno</title>
    ...
    <body>
        ...
        <div class="container">
            <h2>Indicadores 1º Turno Liberação</h2>
            <form method="get" action="fa_indicadores_1_liberacao.cfm" class="form-inline">
                ...
                <button class="btn btn-warning mb-2 ml-2" type="reset" onclick="self.location='fa_indicadores_1_liberacao.cfm'">Limpar</button>
            </form>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <!-- Gráfico para Pareto - LIBERACAO -->
                
    <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script>
        google.charts.load('current', {'packages':['corechart', 'line']});
        google.charts.setOnLoadCallback(drawChartliberacao);

        function drawChartliberacao() {
        ...
        <script type="text/javascript">
            ...
            <meta http-equiv="refresh" content="40,URL=fa_indicadores_1_liberacao.cfm">
    </body>
</html>
