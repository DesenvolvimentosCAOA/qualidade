          ...
          var modalHtml = `
              <div id="blockModal" style="display: flex; justify-content: center; align-items: center; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5);">
                  <div style="background: white; padding: 20px; border-radius: 5px; text-align: center;">
                      ...
                      <button onclick="window.location.BUY OFF HRef='./4fai_selecionar_desbloqueio.cfm'">Me leve a Página</button>
...
<script>
   self.location = 'fa_barreira_hr.cfm';
</script>
</cfif>
<html lang="pt-BR">
   <head>
      ...
      <script>
         function validarFormulario(event) {
             ...
             xhr.send('vin=' + vin + '&problema=' + problema + '&barreira=BUY OFF HR');
   ...
   <body>
      ...
      <div class="container mt-4">
         <h2 class="titulo2">BUY OFF HR</h2>
         <br>
         ...
         <form onsubmit="return validarFormulario(event);" method="post" id="form_envio">
               ...
               <cfoutput>
                  ...
                  <div class="form-group col-md-2">
                     ...
                     <select
                        ...
                        required="required"
                        readonly="readonly">
                        <option value="BUY OFF HR">BUY OFF HR</option>
                     </select>
               </cfoutput>
               </div>
            </div>
            ...
            <!--- Inserir item --->
            <!-- Verifica se o VIN existe na BARREIRA 'BUY OFF HR' -->
            ...
            <cfoutput>
               <script>
                  window.location.href = 'fa_barreira_hr.cfm';
               </script>
            </cfoutput>
            </cfif>
      ...
      <script>
         function deletar(id) {
             if (confirm("Tem certeza que deseja deletar este item?")) {
                 window.location.href = "fa_barreira_hr.cfm?id=" + id;
             }
         }
      </script>
      <script>
