...
<cfquery name="consulta_nconformidades" datasource="#BANCOSINC#">
        WITH CONSULTA AS (
            SELECT PECA, PROBLEMA, COUNT(*) TOTAL_POR_DEFEITO
            FROM INTCOLDFUSION.SISTEMA_QUALIDADE_FA
            WHERE TRUNC(USER_DATA) = 
                <cfif isDefined("url.filtroData") AND NOT isNull(url.filtroData) AND len(trim(url.filtroData)) gt 0>
                    #CreateODBCDate(url.filtroData)#
...
<cfif not isDefined("cookie.USER_APONTAMENTO_FA") or cookie.USER_APONTAMENTO_FA eq "">
    ...
    <body>
        ...
        <!-- Filtro de data -->
        <div class="container">
            <form method="get" action="indicadores_fa.cfm" class="form-inline">
                ...
                <button class="btn btn-warning mb-2 ml-2" type="reset" onclick="self.location='indicadores_fa.cfm'">Limpar</button>
            </form>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                        ...
                        <table class="table table-hover table-sm table-custom-width" border="1" id="tblStocks" data-excel-name="Veículos">
                            <thead>
                                <tr class="text-nowrap">
                                    <th scope="col" colspan="3" class="bg-danger">Principais Não Conformidades - Top 10 (Barreira - T19)</th>
                                </tr>
                                <tr class="text-nowrap">
                ...
                <div class="col-md-6">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-sm table-custom-width" border="1" id="tblStocks" data-excel-name="Veículos">
                            <thead>
                                <tr class="text-nowrap">
                                    <th scope="col" colspan="3" class="bg-success">Principais Não Conformidades - Top 5 (Barreira - T30)</th>
                                </tr>
                                <tr class="text-nowrap">
                                    <th scope="col">Peça</th>
                                    <th scope="col">Problema</th>
                ...
                <div class="col-md-6">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-sm table-custom-width" border="1" id="tblStocks" data-excel-name="Veículos">
                            <thead>
                                <tr class="text-nowrap">
                                    <th scope="col" colspan="3" class="bg-primary">Principais Não Conformidades - Top 10 (Barreira T33)</th>
                                </tr>
                                <tr class="text-nowrap">
                                    <th scope="col">Peça</th>
                                    <th scope="col">Problema</th>
                ...
                <div class="col-md-6">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-sm table-custom-width" border="1" id="tblStocks" data-excel-name="Veículos">
                            <thead>
                                <tr class="text-nowrap">
                                    <th scope="col" colspan="3" class="bg-warning">Principais Não Conformidades - Top 10 (Barreira - C13)</th>
                                </tr>
                                <tr class="text-nowrap">
                                    <th scope="col">Peça</th>
                                    <th scope="col">Problema</th>
                ...
                <!-- Tabela e Gráfico para Liberação F05 -->
                ...
                <div class="col-md-6">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-sm table-custom-width" border="1" id="tblStocks" data-excel-name="Veículos">
                            <thead>
                                <tr class="text-nowrap">
                                    <th scope="col" colspan="3" class="bg-success">Principais Não Conformidades - Top 10 (Barreira - F05)</th>
                                </tr>
                                <tr class="text-nowrap">
                                    <th scope="col">Peça</th>
                                    <th scope="col">Problema</th>
                ...
                <!-- Tabela e Gráfico para Liberação F10 -->
                ...
                <div class="col-md-6">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-sm table-custom-width" border="1" id="tblStocks" data-excel-name="Veículos">
                            <thead>
                                <tr class="text-nowrap">
                                    <th scope="col" colspan="3" class="bg-danger">Principais Não Conformidades - Top 10 (Barreira - F10)</th>
                                </tr>
                                <tr class="text-nowrap">
                                    <th scope="col">Peça</th>
                                    <th scope="col">Problema</th>
                ...
                <!-- Tabela e Gráfico para Liberação sub motor -->
                ...
                <div class="col-md-6">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-sm table-custom-width" border="1" id="tblStocks" data-excel-name="Veículos">
                            <thead>
                                <tr class="text-nowrap">
                                    <th scope="col" colspan="3" class="bg-primary">Principais Não Conformidades - Top 10 (Barreira - Sub-Motor)</th>
                                </tr>
                                <tr class="text-nowrap">
                                    <th scope="col">Peça</th>
                                    <th scope="col">Problema</th>
                ...
                <div class="col-md-6">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-sm table-custom-width" border="1" id="tblStocks" data-excel-name="Veículos">
                            <thead>
                                <tr class="text-nowrap">
                                    <th scope="col" colspan="3" class="bg-warning">Principais Não Conformidades - Top 5 (FA)</th>
                                </tr>
                                <tr class="text-nowrap">
                                    <th scope="col">Peça</th>
                                    <th scope="col">Problema</th>
...
<meta http-equiv="refresh" content="40,URL=indicadores_fa.cfm">
    </body>
</html>
