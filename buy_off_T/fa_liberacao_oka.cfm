    ...
    <cfquery name="combinedQuery" datasource="#BANCOSINC#">
        ...
        ON fa.BARCODE = cor_table.BARCODE
        WHERE fa.CRITICIDADE = 'CRIPPLE'
        AND fa.STATUS_OKA IS NULL
        GROUP BY fa.PECA, fa.MODELO, cor_table.cor
        ORDER BY fa.PECA
    </cfquery>
