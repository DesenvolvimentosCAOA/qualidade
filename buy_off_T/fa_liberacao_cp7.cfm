...
<cfquery name="login" datasource="#BANCOSINC#">
    ...
    <div class="container">
            ...
            <form class="filterTable" name="fitro" method="GET" >
                <div class="row" >                    
                    ...
                    <div class="col-2 d-flex align-items-end">
                        ...
                        <button class="btn btn-warning" type="reset" onclick="self.location='fa_liberacao_cp7.cfm'">Limpar</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="container col-12 bg-white rounded metas">
            <form method="post" action="fa_liberacao_cp7.cfm">
                <table class="table">
                    <thead>
