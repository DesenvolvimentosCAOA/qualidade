...
<cfif structKeyExists(url, "delete_id") and url.delete_id neq "">
  ...
  <cfquery name="delete" datasource="#BANCOSINC#">
      DELETE FROM INTCOLDFUSION.MASSIVA_FA
      ...
      if (confirm("Tem certeza que deseja excluir este registro?")) {
        ...
        <cfif isDefined("url.deletarOK") and url.deletarOK eq "true">
            <cfquery datasource="#BANCOSINC#">
                UPDATE INTCOLDFUSION.MASSIVA_FA 
                SET STATUS = 'LIBERADO' 
                WHERE STATUS = 'OK'
            </cfquery>
            ...
            <div class="tabela">
                ...
                <table class="table">
                    <thead>
                        ...
                        <cfif structKeyExists(cookie, "user_sign") AND cookie.user_sign eq "JEFFERSON ALVES TEIXEIRA" OR cookie.user_sign eq "MICHAEL JONATHAN CAMARGO DE OLIVEIRA">
