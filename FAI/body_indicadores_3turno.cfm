<cfinvoke method="inicializando" component="cf.ini.index">
            ...
            SELECT 
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                     ...
                     AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '01:00' AND '05:00'), 0) AS CP5_TOTAL,
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                     ...
                     AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '01:00' AND '05:00'), 0) AS VALIDACAO_TOTAL,
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                     ...
                     AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '01:00' AND '05:00'), 0) AS PROCESSO_TOTAL,
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                              ...
                              AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '01:00' AND '05:00'), 0) * 100, 2) AS CP5_PERC,
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                              ...
                              AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '01:00' AND '05:00'), 0) * 100, 2) AS VALIDACAO_PERC,
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                              ...
                              AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '01:00' AND '05:00'), 0) * 100, 2) AS PROCESSO_PERC
    ...
    <body>
        ...
        <div class="container">
            <h2>BODY - Indicadores 3º Turno</h2>
            <form method="get" action="body_indicadores_3turno.cfm" class="form-inline">
                ...
                <button class="btn btn-warning mb-2 ml-2" type="reset" onclick="self.location='body_indicadores_3turno.cfm'">Limpar</button>
            </form>
        </div>
...
<script>
   ...
   <meta http-equiv="refresh" content="40,URL=body_indicadores_3turno.cfm">
                        ...
                        <!--- <cfoutput query="consulta_totais">
                            <table border="1" cellpadding="5" cellspacing="0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>CP5</td>
                                        <td>#consulta_totais.CP5_TOTAL#</td>
                                        <td>#consulta_totais.CP5_PERC#%</td>
                                    </tr>
                                    <tr>
                                        <td>VALIDACAO</td>
                                        <td>#consulta_totais.VALIDACAO_TOTAL#</td>
                                        <td>#consulta_totais.VALIDACAO_PERC#%</td>
                                    </tr>
                                    <tr>
                                        <td>PROCESSO</td>
                                        <td>#consulta_totais.PROCESSO_TOTAL#</td>
                                        <td>#consulta_totais.PROCESSO_PERC#%</td>
                                    </tr>
                                    <tr>
                                        <td>SIGN OFF</td>
