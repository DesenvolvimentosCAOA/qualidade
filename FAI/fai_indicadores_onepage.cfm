<cfinvoke method="inicializando" component="cf.ini.index">
    ...
    <cfparam name="url.rownum" default="5" type="integer">
    <cfquery name="consulta_nconformidades" datasource="#BANCOSINC#">
        ...
        CONSULTA2 AS (
            ...
            FROM CONSULTA
            WHERE ROWNUM <= <cfqueryparam cfsqltype="cf_sql_integer" value="#url.rownum#">
        ),
        CONSULTA3 AS (
            SELECT PROBLEMA, PECA, ESTACAO, TOTAL_POR_DEFEITO, 
    ...
    <head>
        ...
        <title>Indicadores - One Page</title>
        <link rel="icon" href="./assets/chery.png" type="image/x-icon">
        <link rel="stylesheet" href="assets/styleonepage.css?v2">
    <body>
        ...
        <div class="container">
            ...
            <form method="get" action="fai_indicadores_onepage.cfm" class="form-inline">
                ...
                <div class="form-group mx-sm-3 mb-2">
                    <label for="rownum" class="sr-only">Quantidade de Registros:</label>
                    <input type="number" class="form-control" name="rownum" id="rownum" min="1" value="<cfif isDefined('url.rownum')>#url.rownum#</cfif>"/>
                </div>
            
                <button class="btn btn-primary mb-2" type="submit">Filtrar</button>
                <button class="btn btn-warning mb-2 ml-2" type="reset" onclick="self.location='fai_indicadores_onepage.cfm'">Limpar</button>
            </form>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <!-- Tabela para Road Test -->
                <div class="col-md-6 move-left">
                    <h3>Road Test</h3>
                    <div class="table-responsive ">
                        <table class="table table-hover table-sm">
                            <thead class="bg-success">
            ...
            <div class="row">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-sm table-custom-width table-wider" border="1" id="tblStocks" data-excel-name="Veículos">
                                <thead>
                                    <tr class="text-nowrap">
                                        <th scope="col" colspan="5" class="bg-warning">Principais Não Conformidades</th>
                                    </tr>
                                    <tr class="text-nowrap">
   ...
   <meta http-equiv="refresh" content="60,URL=fai_indicadores_onepage.cfm">
    </body>
</html>
