...
<html lang="pt-BR">
      <head>
         ...
         <link rel="stylesheet" href="assets/style_barreiras.css?v4">
         <script>
            ...
            function validarFormulario(event) {
                ...
                xhr.send('vin=' + vin + '&problema=' + problema + '&barreira=SIGN OFF');
      ...
      <body>
         ...
         <div class="container mt-4">
            ...
            <form onsubmit="return validarFormulario(event);" method="post" id="form_envio">
               ...
               <!--- Inserir item --->
               <!-- Verifica se o VIN existe na BARREIRA 'SIGN OFF' -->
               ...
               <!-- Se o VIN existe na BARREIRA 'SIGN OFF', usa o intervalo existente -->
               ...
               <cfoutput>
                  <script>
                     window.location.href = 'fai_barreira_exok.cfm';
                  </script>
               </cfoutput>
               </cfif>
         ...
         <script>
            function deletar(id) {
                if (confirm("Tem certeza que deseja deletar este item?")) {
                    window.location.href = "fai_barreira_exok.cfm?id=" + id;
                }
            }
         </script>
         <script>
