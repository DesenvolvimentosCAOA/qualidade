              ...
              <div class="row mb-4">
                <div class="col col-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="data" class="form-control" id="formData" value="#dateFormat(consulta_editar.reparo_data, 'dd/mm/yyyy')#" readonly/>
                  </div>
                </div>
                <div class="col col-3">
                  <div class="form-group">
                ...
                <div class="col col-3">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="estacao" id="formEstacao" required>
                      <option value="#consulta_editar.estacao#">#consulta_editar.responsavel_reparo#</option>
              ...
              <div class="row mb-4">
                <div class="col col-3">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="peca" id="formPeca" required>
                      <option value="#consulta_editar.peca_reparo#" selected>#consulta_editar.peca_reparo#</option>
                ...
                <div class="col col-3">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="local" id="formlocal" required>
                      <option value="#consulta_editar.posicao_reparo#" selected>#consulta_editar.posicao_reparo#</option>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="NConformidade" id="formNConformidade" required>
                    <option value="#consulta_editar.problema_reparo#" selected>#consulta_editar.problema_reparo#</option>
                  ...
                  <div class="col col-3">
                    <button type="submit" form="for-edit" class="btn btn-primary">Salvar</button>
                      <cfif isDefined("form.vin") and form.vin neq "">
                          ...
                          <meta http-equiv="refresh" content="1.5; url=fai_editar_reparo.cfm">
                      </cfif>
                  </div>
                  <div class="col col-3">
                    <button type="reset" id="bt_reset" onclick="self.location = 'fai_editar_reparo.cfm'" class="btn btn-warning">Voltar</button>
                  </div>
                </div>
            </cfoutput>
        </form>
