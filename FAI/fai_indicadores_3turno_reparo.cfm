    ...
    <cfquery name="consulta_barreira" datasource="#BANCOSINC#">
        WITH CONSULTA AS (
            SELECT 
                BARREIRA, VIN,
                CASE 
                    WHEN INTERVALO_REPARO = '01:00' THEN '01:02~02:00'
                    WHEN INTERVALO_REPARO = '02:00' THEN '02:00~03:00'
                    WHEN INTERVALO_REPARO = '03:00' THEN '03:00~04:00'
                    WHEN INTERVALO_REPARO = '04:00' THEN '04:00~05:00'
                    WHEN INTERVALO_REPARO = '05:00' THEN '05:00~06:10'
                END HH,
                CASE 
                    WHEN COUNT(CASE 
            ...
            WHERE TRUNC(REPARO_DATA) = 
                ...
                AND (
                    ...
                    ((TO_CHAR(REPARO_DATA, 'D') BETWEEN '2' AND '5') AND (TO_CHAR(REPARO_DATA, 'HH24:MI:SS') BETWEEN '01:02:00' AND '06:10:00'))
                    -- Sexta-feira: turno inicia às 01:02 e termina às 06:10 do mesmo dia
                    OR ((TO_CHAR(REPARO_DATA, 'D') = '6') AND (TO_CHAR(REPARO_DATA, 'HH24:MI:SS') BETWEEN '01:02:00' AND '06:10:00'))
                    -- Sábado: turno inicia na sexta-feira às 23:00 e termina no sábado às 04:25
                    OR ((TO_CHAR(REPARO_DATA, 'D') = '7') AND (
                        (TO_CHAR(REPARO_DATA, 'HH24:MI:SS') BETWEEN '23:00:00' AND '23:59:59') OR
                        (TO_CHAR(REPARO_DATA, 'HH24:MI:SS') BETWEEN '00:00:00' AND '04:25:00')
                    ))
                )
...
<html lang="pt-BR">
    <head>
        ...
        <title>Indicador Reparo - 3º turno</title>
    ...
    <body>
        ...
        <div class="container">
            <h2>Indicador Reparo 3º Turno</h2>
            <form method="get" action="fai_indicadores_3turno_reparo.cfm" class="form-inline">
                <div class="form-group mx-sm-3 mb-2">
                    ...
                    <button class="btn btn-warning mb-2 ml-2" type="reset" onclick="self.location='fai_indicadores_3turno_reparo.cfm'">Limpar</button>
            </form>
        </div>
