...
<cfquery name="consulta" datasource="#BANCOSINC#">
     ...
     ( 
         ...
         ELSE '' END MODELO_1,
          ...
          CASE WHEN ( SELECT VIN FROM INTCOLDFUSION.SISTEMA_QUALIDADE_FAI RP WHERE UPPER(TRIM(RP.PROBLEMA)) =  UPPER(TRIM(RV.PROBLEMA)) AND ROWNUM = 1 ) IS NOT NULL THEN 'NG' 
              ELSE 'OK'
         END RESULT_1
...
<html lang="pt-br">
    ...
    <body>
        ...
        <h4 class="text-center mt-2">Fechamento Shower</h4>
        ...
        <div class="container col-12 mt-5">
               ...
               <cfoutput>
                <form class="filterTable mt-5" name="fitro" method="GET">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <button class="btn btn-warning" type="reset" onclick="self.location='fechamento_shower.cfm'">Limpar</button>
                        </div>
                    </div>
                </form>
                </cfoutput>
            ...
            <div class="container col-12 bg-white rounded metas" style="height: 80%; overflow-y: auto;">
              ...
              <table border="1" class="table table-hover table-bordered text-center" id="tblStocks" data-excel-name="Veículos" style="border: 1px solid black; border-radius: 10px !important">
                  <thead>
