...
<cfif not isDefined("cookie.user_level_fai") or (cookie.user_level_fai eq "R" or cookie.user_level_fai eq "P" or cookie.user_level_fai eq "I")>
    ...
    <cfif structKeyExists(form, "nome") and structKeyExists(form, "vin") and structKeyExists(form, "local") and structKeyExists(form, "N_Conformidade") and structKeyExists(form, "posicao") and structKeyExists(form, "problema")>
        ...
        <cfif insere.recordCount>
            <script> self.location = "fai_editar.cfm"; </script>
        <cfelse>
    ...
    <script>
        function atualizarRegistro(id) {
            if (confirm("Tem certeza que deseja limpar os dados deste registro?")) {
                ...
                window.location.href = 'fai_editar.cfm?id=' + id;
            }
        }
    </script>
                    ...
                    <form class="filterTable" name="fitro" method="GET">
                        <div class="row">
                            ...
                            <div class="col-md-3 d-flex align-items-end">
                                ...
                                <button class="btn btn-warning" type="reset" onclick="self.location='fai_editar.cfm'">Limpar</button>
                            </div>
                        </div>
                    </form>
                </cfoutput>
                                                ...
                                                <tr class="align-middle">
                                                   ...
                                                   <!---- <td>
                                                    ...
                                                    <td class="text-nowrap">
                                                        <button class="btn btn-primary" onclick="self.location='fai_editar_editar.cfm?id_editar=#id#'">
