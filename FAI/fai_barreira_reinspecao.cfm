    ...
    <head>
        ...
        <meta charset="utf-8">
            <meta
                ...
                <title>TÚNEL DE LIBERAÇÃO</title>
                <link rel="icon" href="./assets/chery.png" type="image/x-icon">
                    ...
                    <body>
                        ...
                        <div class="container mt-4">
                            <h2 class="titulo2">TÚNEL DE LIBERAÇÃO</h2><br>
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="vin"
                                                            id="formVIN"
                                                            title="Insira o VIN Completo"
                                                            required="required"></div>
                                                        <!--- <cfdump var="#buscaMES#"> --->
                                                        <div class="form-group col-md-2">
                                                            <label for="formModelo">
                                                                Modelo</label>
                                                            <input
                                                                type="text"
                                                                class="form-control form-control-sm"
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-2">
                                                                <label for="formNConformidade">
                                                                    Peça</label>
                                                                <select
                                                                    class="form-control form-control-sm"
                                                                    name="N_Conformidade"
                                                                    id="formNConformidade">
                                                                    <option value="">
                                                            ...
                                                            <div class="form-group col-md-2">
                                                                ...
                                                                <select
                                                                    ...
                                                                    name="problema"
                                                                    id="formProblema"
                                                                    oninput="transformToUpperCase(this)">
                                                                    <option value="">
