<cfinvoke method="inicializando" component="cf.ini.index">
   ...
   <cfloop query="consultaVIN">
      <cfif consultaVIN.STATUS_BLOQUEIO EQ "BLOQUEADO" AND consultaVIN.BARREIRA_BLOQUEIO EQ "SIGN OFF">
   ...
   <script>
      self.location = 'fai_barreira_reinspecao.cfm';
   </script>
   </cfif>
<html lang="pt-BR">
      <head>
     ...
     localStorage.setItem('vin', vin);
      ...
      <body>
         ...
         <div class="container mt-4">
            <h2 class="titulo2">TUNEL DE LIBERACAO</h2>
            <br>
            ...
            <form onsubmit="return validarFormulario(event);" method="post" id="form_envio">
                   ...
                   <script>
                     ...
                     <div class="form-group col-md-2">
                        ...
                        <select class="form-control form-control-sm" name="local" id="formLocal" required="required" readonly="readonly">
                           <option value="TUNEL DE LIBERACAO">TUNEL DE LIBERACAO</option>
                        </select>
                  </cfoutput>
                  </div>
               </div>
               ...
               <!--- Inserir item --->
               <!-- Verifica se o VIN existe na BARREIRA 'TUNEL DE LIBERACAO' -->
               ...
               <!-- Se o VIN existe na BARREIRA 'TUNEL DE LIBERACAO', usa o intervalo existente -->
               ...
               <cfoutput>
                  <script>
                     window.location.href = 'fai_barreira_reinspecao.cfm';
                  </script>
               </cfoutput>
               </cfif>
         ...
         <script>
            function deletar(id) {
                if (confirm("Tem certeza que deseja deletar este item?")) {
                    window.location.href = "fai_barreira_reinspecao.cfm?id=" + id;
                }
            }
         </script>
         <script>
