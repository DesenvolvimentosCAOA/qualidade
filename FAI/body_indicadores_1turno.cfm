<cfinvoke method="inicializando" component="cf.ini.index">
            ...
            SELECT 
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                     ...
                     AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '06:00' AND '15:00'), 0) AS CP5_TOTAL,
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                     ...
                     AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '06:00' AND '15:00'), 0) AS VALIDACAO_TOTAL,
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                     ...
                     AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '06:00' AND '15:00'), 0) AS PROCESSO_TOTAL,
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                              ...
                              AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '06:00' AND '15:00'), 0) * 100, 2) AS CP5_PERC,
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                              ...
                              AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '06:00' AND '15:00'), 0) * 100, 2) AS VALIDACAO_PERC,
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                              ...
                              AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '06:00' AND '15:00'), 0) * 100, 2) AS PROCESSO_PERC
            FROM DUAL
        )
        SELECT 
            CP5_TOTAL,
    ...
    <body>
        ...
        <!-- Filtro de data -->
            <div class="container">
            <h2>BODY - Indicadores 1º Turno</h2>
            <form method="get" action="body_indicadores_1turno.cfm" class="form-inline">
                ...
                <button class="btn btn-warning mb-2 ml-2" type="reset" onclick="self.location='body_indicadores_1turno.cfm'">Limpar</button>
            </form>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-4">
                    <h3 style="margin-left:50px">CP5</h3>
...
<script>
   ...
   <meta http-equiv="refresh" content="40,URL=body_indicadores_1turno.cfm">
