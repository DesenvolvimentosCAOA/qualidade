<cfinvoke method="inicializando" component="cf.ini.index">
    ...
    <script>
       self.location = 'fai_barreira_shower.cfm';
    </script>
    </cfif>
<html lang="pt-BR">
       <head>
      ...
      localStorage.setItem('vin', vin);
                 ...
                 xhr.send('vin=' + vin + '&problema=' + problema + '&barreira=SHOWER');
       ...
       <body>
          ...
          <div class="container mt-4">
             ...
             <form onsubmit="return validarFormulario(event);" method="post" id="form_envio">
                ...
                <!--- Inserir item --->
                <!-- Verifica se o VIN existe na BARREIRA 'SHOWER' -->
                ...
                <!-- Se o VIN existe na BARREIRA 'SHOWER', usa o intervalo existente -->
                ...
                <cfoutput>
                   <script>
                      window.location.href = 'fai_barreira_shower.cfm';
                   </script>
                </cfoutput>
                </cfif>
          ...
          <script>
             function deletar(id) {
                 if (confirm("Tem certeza que deseja deletar este item?")) {
                     window.location.href = "fai_barreira_shower.cfm?id=" + id;
                 }
             }
          </script>
          <script>
