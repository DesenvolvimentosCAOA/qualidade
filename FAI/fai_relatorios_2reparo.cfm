<cfinvoke method="inicializando" component="cf.ini.index">
    ...
    <cfquery name="consulta_adicionais" datasource="#BANCOSINC#">
        ...
        AND INTERVALO_REPARO IN ('15:50', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00', '23:00', '00:00')
        AND (
            (TO_CHAR(REPARO_DATA, 'D') BETWEEN 2 AND 6 -- Segunda a Quinta-feira
                        AND INTERVALO_REPARO IN ('15:50', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00', '23:00', '00:00')
                        AND CASE 
                                WHEN TO_CHAR(REPARO_DATA, 'HH24:MI') <= '02:00' THEN TRUNC(REPARO_DATA - 1) 
                                ELSE TRUNC(REPARO_DATA) 
                            END = CASE 
                ...
                OR (TO_CHAR(REPARO_DATA, 'D') = '7' -- Sexta-feira
                    AND INTERVALO_REPARO IN ('15:00', '15:50', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00', '23:00', '00:00')
                    AND TO_CHAR(REPARO_DATA, 'HH24:MI') BETWEEN '15:00' AND '23:00'
                    AND CASE 
                            WHEN TO_CHAR(REPARO_DATA, 'HH24:MI') <= '02:00' THEN TRUNC(REPARO_DATA - 1) 
                            ELSE TRUNC(REPARO_DATA) 
                        END = CASE 
...
<html lang="pt-BR">
    <head>
        ...
        <title>Relatório CP8 2º Turno</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <button style="background-color:green; color:white;" class="btn btn-warning mb-2 ml-2" onclick="self.location='fai_relatorios_2reparo.cfm'">2º Turno</button>
            <button class="btn btn-warning mb-2 ml-2" onclick="self.location='fai_relatorios_3reparo.cfm'">3º Turno</button>
            <h2>Relatório CP8 2º Turno</h2>
            <form method="get">
                <div class="form-row">
                    <cfoutput>
                        ...
                        <button class="btn btn-warning mb-2 ml-2" type="reset" onclick="self.location='fai_relatorios_2reparo.cfm'">Limpar</button>
