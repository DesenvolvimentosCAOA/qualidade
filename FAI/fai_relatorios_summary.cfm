        ...
        <header>
                ...
                <div class="form-row">
                    <div class="col-md-12">
                        <div class="form-buttons">
                            ...
                            <button type="reset" class="btn btn-primary" style="background:gold; color:black; border-color: gold" onclick="self.location='fai_relatorios_summary.cfm'">Limpar</button>
                        </div>
                    </div>
                </div>
            </form>
            <div class="container col-12 bg-white rounded metas">
                ...
                <cfquery name="contagemVin" dbtype="query">
                    SELECT COUNT(DISTINCT VIN) AS totalDistintos
                ...
                <cfquery name="contagemVinSemProblema" dbtype="query">
                    SELECT COUNT(DISTINCT VIN) AS totalDistintosSemProblema
                    FROM consulta_adicionais
                ...
                <cfquery name="contagemtiggo7" dbtype="query">
                    SELECT COUNT(DISTINCT VIN) AS totaltiggo7
                    FROM consulta_adicionais
                    WHERE PROBLEMA IS NULL
                ...
                <cfquery name="contagemtiggo5" dbtype="query">
                    SELECT COUNT(DISTINCT VIN) AS totaltiggo5
                    FROM consulta_adicionais
                    WHERE PROBLEMA IS NULL
                ...
                <cfquery name="contagemtiggo18" dbtype="query">
                    SELECT COUNT(DISTINCT VIN) AS totaltiggo18
                    FROM consulta_adicionais
                    WHERE PROBLEMA IS NULL
                ...
                <cfquery name="contagemHR" dbtype="query">
                    SELECT COUNT(DISTINCT VIN) AS totalHR
                    FROM consulta_adicionais
                    WHERE PROBLEMA IS NULL
                ...
                <cfquery name="contagemTL" dbtype="query">
                    SELECT COUNT(DISTINCT VIN) AS totalTL
                    FROM consulta_adicionais
                    WHERE PROBLEMA IS NULL
                ...
                <cfquery name="contagemtiggo8" dbtype="query">
                    SELECT COUNT(DISTINCT VIN) AS totaltiggo8
                    FROM consulta_adicionais
                    WHERE PROBLEMA IS NULL
