<cfinvoke method="inicializando" component="cf.ini.index">
   ...
   <cfloop query="consultaVIN">
      <cfif consultaVIN.STATUS_BLOQUEIO EQ "BLOQUEADO" AND consultaVIN.BARREIRA_BLOQUEIO EQ "UNDER BODY">
   ...
   <script>
      self.location = 'fai_barreira_ub2.cfm';
   </script>
   </cfif>
<html lang="pt-BR">
      <head>
         ...
         <script>
           ...
           function validarFormulario(event) {
               ...
               xhr.send('vin=' + vin + '&problema=' + problema + '&barreira=UNDER BODY');
      ...
      <body>
         ...
         <div class="container mt-4">
            <h2 class="titulo2">UNDER BODY</h2>
            <br>
            ...
            <form onsubmit="return validarFormulario(event);" method="post" id="form_envio">
               ...
               <!--- Inserir item --->
               <!-- Verifica se o VIN existe na BARREIRA 'UNDER BODY' -->
               ...
               <!-- Se o VIN existe na BARREIRA 'UNDER BODY', usa o intervalo existente -->
               ...
               <cfoutput>
                  <script>
                     window.location.href = 'fai_barreira_ub2.cfm';
                  </script>
               </cfoutput>
               </cfif>
         ...
         <script>
            function deletar(id) {
                if (confirm("Tem certeza que deseja deletar este item?")) {
                    window.location.href = "fai_barreira_ub2.cfm?id=" + id;
                }
            }
         </script>
         <script>
