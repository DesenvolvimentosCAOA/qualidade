...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="container mt-4">
            <h2 class="titulo2">UNDER BODY 2</h2><br>
        ...
        <div class="form-group col-md-2">
            ...
            <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control form-control-sm" minlength="17" name="vin" id="formVIN" title="Insira o VIN Completo" required="required"></div>
                <!--- <cfdump var="#buscaMES#"> --->
                <div class="form-group col-md-2">
                    ...
                    <input type="text" class="form-control form-control-sm" maxlength="17" name="modelo" id="formModelo" readonly="readonly">
                        <input id="modelo" name="modelo" type="hidden" value="<cfif isDefined("buscaMES.name")>#buscaMES.name#<cfelse></cfif>"></div>
                        <div class="form-group col-md-2">
                ...
                <cfif isDefined("form.VIN") and form.VIN neq "">
                    ...
                    <cfquery name="insere" datasource="#BANCOSINC#">
                        ...
                        ELSE SYSDATE
                        END, <cfqueryparam value="#form.nome#" cfsqltype="CF_SQL_VARCHAR">
