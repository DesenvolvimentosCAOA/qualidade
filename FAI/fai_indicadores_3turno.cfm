<cfinvoke method="inicializando" component="cf.ini.index">
            ...
            SELECT 
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                     ...
                     AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '01:00' AND '05:00'), 0) AS UNDER_BODY_TOTAL,
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                     ...
                     AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '01:00' AND '05:00'), 0) AS ROAD_TEST_TOTAL,
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                     ...
                     AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '01:00' AND '05:00'), 0) AS SHOWER_TOTAL,
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                     ...
                     AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '01:00' AND '05:00'), 0) AS SIGN_OFF_TOTAL,
        
                ROUND(NVL((SELECT COUNT(DISTINCT VIN) 
                     FROM sistema_qualidade_fai 
                     WHERE BARREIRA = 'UNDER BODY' 
                     AND TRUNC(USER_DATA) = TRUNC(SYSDATE)
                     AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '01:00' AND '05:00'
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                              ...
                              AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '01:00' AND '05:00'), 0) * 100, 2) AS UNDER_BODY_PERC,
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                              ...
                              AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '01:00' AND '05:00'), 0) * 100, 2) AS ROAD_TEST_PERC,
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                              ...
                              AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '01:00' AND '05:00'), 0) * 100, 2) AS SHOWER_PERC,
                ...
                <cfelse>
                    TRUNC(SYSDATE)
                              ...
                              AND TO_CHAR(USER_DATA, 'HH24:MI') BETWEEN '01:00' AND '05:00'), 0) * 100, 2) AS SIGN_OFF_PERC
    ...
    <body>
        ...
        <div class="container">
            <h2>FAI - Indicadores 3º Turno</h2>
            <form method="get" action="fai_indicadores_3turno.cfm" class="form-inline">
                ...
                <button class="btn btn-warning mb-2 ml-2" type="reset" onclick="self.location='fai_indicadores_3turno.cfm'">Limpar</button>
            </form>
        </div>
   ...
   <meta http-equiv="refresh" content="40,URL=fai_indicadores_3turno.cfm">
                        ...
                        <!--- <cfoutput query="consulta_totais">
                            <table border="1" cellpadding="5" cellspacing="0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>UNDER BODY</td>
                                        <td>#consulta_totais.UNDER_BODY_TOTAL#</td>
                                        <td>#consulta_totais.UNDER_BODY_PERC#%</td>
                                    </tr>
                                    <tr>
                                        <td>ROAD TEST</td>
                                        <td>#consulta_totais.ROAD_TEST_TOTAL#</td>
                                        <td>#consulta_totais.ROAD_TEST_PERC#%</td>
                                    </tr>
                                    <tr>
                                        <td>SHOWER</td>
                                        <td>#consulta_totais.SHOWER_TOTAL#</td>
                                        <td>#consulta_totais.SHOWER_PERC#%</td>
                                    </tr>
                                    <tr>
                                        <td>SIGN OFF</td>
                                        <td>#consulta_totais.SIGN_OFF_TOTAL#</td>
                                        <td>#consulta_totais.SIGN_OFF_PERC#%</td>
                                    </tr>
                                    <tr>
