<img src="assets/banner_bg.jpg" alt="Título" class="titulo-img">
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            <a class="navbar-brand">Final Assembly Inspection</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="fai_selecionar_buy_off.cfm" style="color: white; font-size: 1.1rem;">Buy Off's</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="fai_reparo.cfm" style="color: white; font-size: 1.1rem;">Reparo</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="fai_liberacao.cfm" style="color: white; font-size: 1.1rem;">Liberação</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="fai_relatorios.cfm" style="color: white; font-size: 1.1rem;">Relatórios</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="fai_indicadores_1turno.cfm">Indicadores 1º turno</a>
                            <a class="dropdown-item" href="#">Indicadores 2º turno</a>
                            <a class="dropdown-item" href="indicadores_fai3.cfm">Indicadores 3º turno</a>
                        </div>
                    </li>
                    <li class="nav-item">
