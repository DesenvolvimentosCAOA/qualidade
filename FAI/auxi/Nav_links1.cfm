    ...
    <input type="checkbox" id="check">
        ...
        <ul>
           ...
           <!--- <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a href="fai_indicadores_1turno.cfm">FAI - 1º Turno</a>
                    </li>
                    <li>
                        <a href="fai_indicadores_2turno.cfm">FAI - 2º Turno</a>
                    </li>
                    <li>
                        <a href="fai_indicadores_3turno.cfm">FAI - 3º Turno</a>
                    </li>
                </ul>
            </li> --->
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a href="body_indicadores_1turno.cfm">BODY - 1º Turno</a>
                    </li>
                    <li>
                        <a href="body_indicadores_2turno.cfm">BODY - 2º Turno</a>
                    </li>
                    <li>
                        <a href="body_indicadores_3turno.cfm">BODY - 3º Turno</a>
                    </li>
                    <li>
                        <a href="indicadores_paint.cfm">PAINT - 1º Turno</a>
                    </li>
                    <li>
                        <a href="indicadores_paint2.cfm">PAINT - 2º Turno</a>
                    </li>
                    <li>
                        <a href="indicadores_paint3.cfm">PAINT - 3º Turno</a>
                    </li>
                    <li>
                        <a href="fa_indicadores_1_esteira.cfm">FA - 1º Turno</a>
                    </li>
                    <li>
                        <a href="fa_indicadores_2_esteira.cfm">FA - 2º Turno</a>
                    </li>
                    <li>
                        <a href="fa_indicadores_3_esteira.cfm">FA - 3º Turno</a>
                    </li>
                    <li>
                        <a href="fai_indicadores_1turno.cfm">FAI - 1º Turno</a>
                    </li>
