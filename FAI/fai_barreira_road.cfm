...
<cfif structKeyExists(form, "nome") and structKeyExists(form, "vin") and structKeyExists(form, "modelo") and structKeyExists(form, "local") and structKeyExists(form, "N_Conformidade") and structKeyExists(form, "posicao") and structKeyExists(form, "problema")>
    ...
    <body>
        ...
        <div class="container mt-4">
            <h2 class="titulo2">Road Test</h2><br>
...
<!---                     <cfdump  var="#consulta1#"> --->
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control form-control-sm"   minlength="17"  name="vin" id="formVIN" title="Insira o VIN Completo" required >
                    </div>
...
<!--- <cfdump var="#buscaMES#"> --->
    ...
    <cfoutput><script>window.location.href = 'fai_barreira_road.cfm';</script></cfoutput>
                </cfif>
