<cfinvoke method="inicializando" component="cf.ini.index">
   ...
   <cfloop query="consultaVIN">
      <cfif consultaVIN.STATUS_BLOQUEIO EQ "BLOQUEADO" AND consultaVIN.BARREIRA_BLOQUEIO EQ "ROAD TEST">
   ...
   <cfquery name="delete" datasource="#BANCOSINC#">
      DELETE FROM INTCOLDFUSION.SISTEMA_QUALIDADE_FAI WHERE ID = 
      <cfqueryparam value="#url.id#" cfsqltype="CF_SQL_INTEGER">
   </cfquery>
   <script>
      self.location = 'fai_barreira_road.cfm';
   </script>
   </cfif>
<html lang="pt-BR">
      <head>
         ...
         <script>
           ...
           window.onload = function() {
                 var savedVIN = localStorage.getItem('vin');
                 if (savedVIN) {
           ...
           function validarFormulario(event) {
               ...
               xhr.send('vin=' + vin + '&problema=' + problema + '&barreira=ROAD TEST');
      ...
      <body>
         ...
         <div class="container mt-4">
            ...
            <form onsubmit="return validarFormulario(event);" method="post" id="form_envio">
                  ...
                  <cfoutput>
                   ...
                   <script>
                       ...
                       document.getElementById('clearVin').addEventListener('click', function() {
                          ...
                          localStorage.removeItem('vin');  // Remove o VIN do localStorage, se necessário
                       });
                    </script>
                     <!--- <cfdump var="#buscaMES#"> --->
                     <div class="form-group col-md-2">
               ...
               <!--- Inserir item --->
               <!-- Verifica se o VIN existe na BARREIRA 'ROAD TEST' -->
               ...
               <!-- Se o VIN existe na BARREIRA 'ROAD TEST', usa o intervalo existente -->
               ...
               <cfquery name="insere" datasource="#BANCOSINC#">
                  ...
                  CASE
                  WHEN
                    <cfqueryparam value="#form.criticidade#" cfsqltype="CF_SQL_VARCHAR">='N0' THEN 'LIBERADO'
                  WHEN 
                    <cfqueryparam value="#form.criticidade#" cfsqltype="CF_SQL_VARCHAR">= 'AVARIA' THEN 'LIBERADO'
                  WHEN 
                    <cfqueryparam value="#form.criticidade#" cfsqltype="CF_SQL_VARCHAR">= 'OK A-' THEN 'LIBERADO'
                  WHEN 
                    <cfqueryparam value="#form.criticidade#" cfsqltype="CF_SQL_VARCHAR">= 'N1' OR 
               ...
               <cfoutput>
                  <script>
                     window.location.href = 'fai_barreira_road.cfm';
                  </script>
               </cfoutput>
               </cfif>
         ...
         <script>
            function deletar(id) {
                if (confirm("Tem certeza que deseja deletar este item?")) {
                    window.location.href = "fai_barreira_road.cfm?id=" + id;
                }
            }
         </script>
         <script>
