    ...
    <input type="checkbox" id="check">
        ...
        <ul>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a href="fai_indicadores_1turno.cfm">1º Turno</a>
                    </li>
                    <li>
                        <a href="fai_indicadores_2turno.cfm">2º Turno</a>
                    </li>
                    <li>
                        <a href="fai_indicadores_3turno.cfm">3º Turno</a>
                    </li>
                </ul>
            </li>
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a href="#" onclick="validateLogin()">Editar Lançamento</a>
                    </li>
                    <li>
            ...
            <li>
                <a href="acompanhamento_road.cfm">Liderança</a>
            </li>
            <li>
    ...
    <script>
        function validateLogin() {
            ...
            if (username === "admin" && password === "1234") {
                window.location.href = "fai_editar.cfm";
            } else {
