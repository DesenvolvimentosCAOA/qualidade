<cfinvoke method="inicializando" component="cf.ini.index">
 ...
 <!--- Se o código chegou até aqui, significa que o VIN não está bloqueado. O formulário pode ser enviado. --->
    ...
    <!-- Verifica se o VIN existe na BARREIRA 'PROCESSO' -->
    ...
    <cfif verificaIntervalo.recordCount gt 0>
       <!-- Se o VIN existe na BARREIRA 'PROCESSO', usa o intervalo existente -->
    ...
    <cfif structKeyExists(url, "id") and url.id neq "">
        ...
        <script>
            self.location = 'body_barreira_processo.cfm';
        </script>
    </cfif>
 ...
 <script>
    function validarFormulario(event) {
        ...
        xhr.send('barcode=' + encodeURIComponent(barcode) + '&problema=' + encodeURIComponent(problema) + '&barreira=PROCESSO');
    ...
    <body>
        ...
        <div class="container mt-4">
            <h2 class="titulo2">Barreira PROCESSO</h2>
        ...
        <script>
            function deletar(id) {
                if (confirm("Tem certeza que deseja deletar este item?")) {
                    window.location.href = "body_barreira_processo.cfm?id=" + id;
                }
            }
        </script> 
 <script>
