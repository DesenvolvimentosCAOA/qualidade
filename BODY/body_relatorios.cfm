            ...
            <form method="get">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <button type="reset" class="btn btn-primary mt-4" style="background:gold; color:black; border-color: gold" onclick="self.location='body_relatorios.cfm'">Limpar</button>
