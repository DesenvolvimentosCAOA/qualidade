...
<script>
    function validarFormulario(event) {
        ...
        xhr.send('barcode=' + encodeURIComponent(barcode) + '&problema=' + encodeURIComponent(problema) + '&barreira=HR');
    ...
    <body>
        ...
        <div class="container mt-4">
            <h2 class="titulo2">Barreira HR</h2><br>
...
<!---                     <cfdump  var="#consulta1#"> --->
                <div class="form-group col-md-2">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input id="modelo" name="modelo" type="hidden" value="HR">
                    </div>
                    <div class="form-group col-md-2">
