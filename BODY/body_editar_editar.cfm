              ...
              <div class="row mb-4">
                ...
                <div class="col col-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="modelo" id="formModelo" value="#consulta_editar.modelo#" required/>
                  </div>
                </div>
                <div class="col col-3">
                  <div class="form-group">
                  ...
                  <div class="col col-3">
                    <button type="submit" form="for-edit" class="btn btn-primary">Salvar</button>
                      <cfif isDefined("form.vin") and form.vin neq "">
                          ...
                          <meta http-equiv="refresh" content="1.5; url=body_editar.cfm">
                      </cfif>
                  </div>
                  <div class="col col-3">
                    <button type="reset" id="bt_reset" onclick="self.location = 'body_editar.cfm'" class="btn btn-warning">Voltar</button>
                  </div>
                </div>
            </cfoutput>
        </form>
