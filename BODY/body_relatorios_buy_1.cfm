...
<html lang="pt-BR">
    <head>
        ...
        <title>Relatório CP5 1º Turno</title>
    ...
    <body>
        ...
        <div class="container">
            <button style="background-color:green; color:white;" class="btn btn-warning mb-2 ml-2" onclick="self.location='body_relatorios_buy_1.cfm'">1º Turno</button>
            <button class="btn btn-warning mb-2 ml-2" onclick="self.location='body_relatorios_buy_2.cfm'">2º Turno</button>
            <button class="btn btn-warning mb-2 ml-2" onclick="self.location='body_relatorios_buy_3.cfm'">3º Turno</button>
            <h2>Relatório CP5 1º Turno</h2>
            <form method="get">
                <div class="form-row">
                    <cfoutput>
                        ...
                        <button class="btn btn-warning mb-2 ml-2" type="reset" onclick="self.location='body_relatorios_buy_1.cfm'">Limpar</button>
                    ...
                    <tbody class="table-group-divider">
                        <cfoutput>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tiggo7.recordcount#">
                                <cfif consulta_barreira_tiggo7.BARREIRA[i] EQ "CHASSI">
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tiggo5.recordcount#">
                                <cfif consulta_barreira_tiggo5.BARREIRA[i] EQ "CHASSI">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>CHASSI</strong></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tiggo18.recordcount#">
                                <cfif consulta_barreira_tiggo18.BARREIRA[i] EQ "CHASSI">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>CHASSI</strong></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_t1a.recordcount#">
                                <cfif consulta_barreira_t1a.BARREIRA[i] EQ "CHASSI">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>CHASSI</strong></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tl.recordcount#">
                                <cfif consulta_barreira_tl.BARREIRA[i] EQ "CHASSI">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>CHASSI</strong></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_hr.recordcount#">
                                <cfif consulta_barreira_hr.BARREIRA[i] EQ "CHASSI">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>CHASSI</strong></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tiggo7.recordcount#">
                                <cfif consulta_barreira_tiggo7.BARREIRA[i] EQ "CP5">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>CP5</strong></td>
                                        <td colspan="1" class="text-end"><strong>T1E</strong></td>
                                        <td></td>
                                        <td colspan="1" class="text-end"><strong>#consulta_barreira_tiggo7.TOTAL[i]#</strong></td>
                                        <td colspan="1" class="text-end"><strong>#consulta_barreira_tiggo7.APROVADOS[i]#</strong></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tiggo5.recordcount#">
                                <cfif consulta_barreira_tiggo5.BARREIRA[i] EQ "CP5">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>CP5</strong></td>
                                        <td colspan="1" class="text-end"><strong>T19</strong></td>
                                        <td></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tiggo18.recordcount#">
                                <cfif consulta_barreira_tiggo18.BARREIRA[i] EQ "CP5">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>CP5</strong></td>
                                        <td colspan="1" class="text-end"><strong>T18</strong></td>
                                        <td></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_t1a.recordcount#">
                                <cfif consulta_barreira_t1a.BARREIRA[i] EQ "CP5">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>CP5</strong></td>
                                        <td colspan="1" class="text-end"><strong>T1A</strong></td>
                                        <td></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tl.recordcount#">
                                <cfif consulta_barreira_tl.BARREIRA[i] EQ "CP5">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>CP5</strong></td>
                                        <td colspan="1" class="text-end"><strong>TL</strong></td>
                                        <td></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_hr.recordcount#">
                                <cfif consulta_barreira_hr.BARREIRA[i] EQ "CP5">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>CP5</strong></td>
                                        <td colspan="1" class="text-end"><strong>HR</strong></td>
                                        <td></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tiggo7.recordcount#">
                                <cfif consulta_barreira_tiggo7.BARREIRA[i] EQ "SUPERFICIE">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>SUPERFICIE</strong></td>
                                        <td colspan="1" class="text-end"><strong>T1E</strong></td>
                                        <td></td>
                                        <td colspan="1" class="text-end"><strong>#consulta_barreira_tiggo7.TOTAL[i]#</strong></td>
                                        <td colspan="1" class="text-end"><strong>#consulta_barreira_tiggo7.APROVADOS[i]#</strong></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tiggo5.recordcount#">
                                <cfif consulta_barreira_tiggo5.BARREIRA[i] EQ "SUPERFICIE">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>SUPERFICIE</strong></td>
                                        <td colspan="1" class="text-end"><strong>T19</strong></td>
                                        <td></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tiggo18.recordcount#">
                                <cfif consulta_barreira_tiggo18.BARREIRA[i] EQ "SUPERFICIE">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>SUPERFICIE</strong></td>
                                        <td colspan="1" class="text-end"><strong>T18</strong></td>
                                        <td></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_t1a.recordcount#">
                                <cfif consulta_barreira_t1a.BARREIRA[i] EQ "SUPERFICIE">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>SUPERFICIE</strong></td>
                                        <td colspan="1" class="text-end"><strong>T1A</strong></td>
                                        <td colspan="1" class="text-end"><strong>#consulta_barreira_t1a.TOTAL[i]#</strong></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tl.recordcount#">
                                <cfif consulta_barreira_tl.BARREIRA[i] EQ "SUPERFICIE">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>SUPERFICIE</strong></td>
                                        <td colspan="1" class="text-end"><strong>TL</strong></td>
                                        <td></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_hr.recordcount#">
                                <cfif consulta_barreira_hr.BARREIRA[i] EQ "SUPERFICIE">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>SUPERFICIE</strong></td>
                                        <td colspan="1" class="text-end"><strong>HR</strong></td>
                                        <td></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tiggo7.recordcount#">
                                <cfif consulta_barreira_tiggo7.BARREIRA[i] EQ "HR">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>CP5</strong></td>
                                        <td colspan="1" class="text-end"><strong>T1E</strong></td>
                                        <td></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tiggo5.recordcount#">
                                <cfif consulta_barreira_tiggo5.BARREIRA[i] EQ "HR">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>CP5</strong></td>
                                        <td colspan="1" class="text-end"><strong>T19</strong></td>
                                        <td></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tiggo18.recordcount#">
                                <cfif consulta_barreira_tiggo18.BARREIRA[i] EQ "HR">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>CP5</strong></td>
                                        <td colspan="1" class="text-end"><strong>T18</strong></td>
                                        <td></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_t1a.recordcount#">
                                <cfif consulta_barreira_t1a.BARREIRA[i] EQ "HR">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>CP5</strong></td>
                                        <td colspan="1" class="text-end"><strong>T1A</strong></td>
                                        <td></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tl.recordcount#">
                                <cfif consulta_barreira_tl.BARREIRA[i] EQ "HR">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>CP5</strong></td>
                                        <td colspan="1" class="text-end"><strong>TL</strong></td>
                                        <td></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tiggo7.recordcount#">
                                <cfif consulta_barreira_tiggo7.BARREIRA[i] EQ "PROCESSO">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>PROCESSO</strong></td>
                                        <td colspan="1" class="text-end"><strong>T1E</strong></td>
                                        <td></td>
                                        <td colspan="1" class="text-end"><strong>#consulta_barreira_tiggo7.TOTAL[i]#</strong></td>
                                        <td colspan="1" class="text-end"><strong>#consulta_barreira_tiggo7.APROVADOS[i]#</strong></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tiggo5.recordcount#">
                                <cfif consulta_barreira_tiggo5.BARREIRA[i] EQ "PROCESSO">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>PROCESSO</strong></td>
                                        <td colspan="1" class="text-end"><strong>T19</strong></td>
                                        <td></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tiggo18.recordcount#">
                                <cfif consulta_barreira_tiggo18.BARREIRA[i] EQ "PROCESSO">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>PROCESSO</strong></td>
                                        <td colspan="1" class="text-end"><strong>T18</strong></td>
                                        <td></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_t1a.recordcount#">
                                <cfif consulta_barreira_t1a.BARREIRA[i] EQ "PROCESSO">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>PROCESSO</strong></td>
                                        <td colspan="1" class="text-end"><strong>T1A</strong></td>
                                        <td></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_tl.recordcount#">
                                <cfif consulta_barreira_tl.BARREIRA[i] EQ "PROCESSO">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>PROCESSO</strong></td>
                                        <td colspan="1" class="text-end"><strong>TL</strong></td>
                                        <td></td>
                            ...
                            <cfloop index="i" from="1" to="#consulta_barreira_hr.recordcount#">
                                <cfif consulta_barreira_hr.BARREIRA[i] EQ "PROCESSO">
                                    <tr class="align-middle">
                                        <td colspan="1" class="text-end"><strong>PROCESSO</strong></td>
                                        <td colspan="1" class="text-end"><strong>HR</strong></td>
                                        <td></td>
