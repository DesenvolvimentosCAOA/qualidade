...
<html lang="pt-BR">
    ...
    <body>
        ...
        <cfoutput>
            <div class="container">
                <h2>BODY 2º Turno</h2>
                <form method="get" action="body_indicadores_2.cfm" class="form-inline">
                    ...
                    <button class="btn btn-warning mb-2 ml-2" type="reset" onclick="self.location='body_indicadores_2.cfm'">Limpar</button>
                </form>
            </div>
            </cfoutput>
        ...
        <meta http-equiv="refresh" content="40,URL=body_indicadores_2.cfm">
    </body>
</html>