...
<html lang="pt-BR">
    <head>
        ...
        <title>Relatório CP5 2º Turno</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <button style="background-color:green; color:white;" class="btn btn-warning mb-2 ml-2" onclick="self.location='body_relatorios_buy_2.cfm'">2º Turno</button>
            <button class="btn btn-warning mb-2 ml-2" onclick="self.location='body_relatorios_buy_3.cfm'">3º Turno</button>
            <h2>Relatório CP5 2º Turno</h2>
            <form method="get">
                <div class="form-row">
                    <cfoutput>
