...
<html lang="pt-BR">
    <head>
        ...
        <title>Relatório CP5 3º Turno</title>
    ...
    <body>
        ...
        <div class="container">
            <button class="btn btn-warning mb-2 ml-2" onclick="self.location='body_relatorios_buy_1.cfm'">1º Turno</button>
            <button class="btn btn-warning mb-2 ml-2" onclick="self.location='body_relatorios_buy_2.cfm'">2º Turno</button>
            <button style="background-color:green; color:white;" class="btn btn-warning mb-2 ml-2" onclick="self.location='body_relatorios_buy_3.cfm'">3º Turno</button>
            <h2>Relatório CP5 3º Turno</h2>
            <form method="get">
                <div class="form-row">
                    <cfoutput>
                        ...
                        <button class="btn btn-warning mb-2 ml-2" type="reset" onclick="self.location='body_relatorios_buy_3.cfm'">Limpar</button>
