<cfinvoke method="inicializando" component="cf.ini.index">
 ...
 <!--- Se o código chegou até aqui, significa que o VIN não está bloqueado. O formulário pode ser enviado. --->
    ...
    <!-- Verifica se o VIN existe na BARREIRA 'CP5' -->
    ...
    <cfif verificaIntervalo.recordCount gt 0>
       <!-- Se o VIN existe na BARREIRA 'CP5', usa o intervalo existente -->
    ...
    <cfoutput><script>window.location.href = 'body_barreira_cp5.cfm';</script></cfoutput>
    ...
    <cfif structKeyExists(url, "id") and url.id neq "">
        ...
        <script>
            self.location = 'body_barreira_cp5.cfm';
        </script>
    </cfif>
        ...
        <script>
            function deletar(id) {
                if (confirm("Tem certeza que deseja deletar este item?")) {
                    window.location.href = "body_barreira_cp5.cfm?id=" + id;
                }
            }
        </script> 
 <script>
